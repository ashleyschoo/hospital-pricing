...
urlpatterns = [
    ...
    path('pricing/new/', views.PricingCreateView.as_view(), name='pricing_new'),
	path('pricing/<int:pk>/delete/', views.PricingDeleteView.as_view(), name='pricing_delete'),
	path('pricing/<int:pk>/update/', views.PricingUpdateView.as_view(), name='pricing_update'),
	path('pricing_filter/', views.PricingFilterView.as_view(), kwargs=None, name='pricing_filter'),	
